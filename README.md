...
- Serves a dark dashboard for choosing a test latitude/longitude and downloading a removable iPhone configuration profile.
...
- Includes a dedicated-VPS Nginx SNI router, systemd unit, and bootstrap script.
...
The script rejects Apple/iCloud production hostnames, obtains a normal public certificate for the dashboard/DoH hostname, generates the private lab CA server-side, and configures exact-SNI routing only for the public hostname and the three derived lab subdomains.
